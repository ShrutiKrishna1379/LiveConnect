  ...
  return (
    <div className='w-full h-[100vh] bg-slate-200 flex items-center justify-center'>
      <div className='w-full max-w-[500px] h-[600px] bg-white rounded-lg shadow-gray-400 shadow-lg flex flex-col gap-[10px]'>
        ...
        <form className='w-full pt-8 flex flex-col gap-[20px] items-center'onSubmit={handleLogin} >
          ...
          <div className='w-[80%] h-[50px] border-2 border-[#e4cb0ac8] overflow-hidden rounded-lg shadow-gray-200 shadow-lg relative'>
            ...
            <span className='absolute top-[10px] right-[20px] text-[19px] text-[#e4cb0ac8] font-semibold cursor-pointer' on onClick={()=>setShow(prev=>!prev)}>{`${show?"hidden":"show"}`}</span>
          </div>
